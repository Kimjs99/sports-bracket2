...
const ADMIN_SECTIONS = [
  {
    ...
    steps: [
      ...
      '운영자에게 배부받은 등록 코드를 입력합니다. 코드가 없으면 등록할 수 없습니다.',
  ...
  },
  {
    ...
    steps: [
      ...
      '대진 배정 방식을 선택합니다. (자동 추첨: 무작위 / 수동 배정: 팀 순서·조를 직접 지정)',
      '팀 이름을 직접 입력하거나 CSV·Excel 파일을 업로드합니다.',
      '"대진 생성"을 누릅니다.',
    ],
    note: '리그전 7팀 이상은 조별 리그+토너먼트로 자동 전환됩니다. 수동 배정 시 토너먼트는 팀 목록 순서대로(1·2번, 3·4번…) 맞붙고, 조별리그는 팀마다 조를 직접 지정합니다.',
  },
  {
    icon: RefreshCw,
    title: '대진 재구성',
    ...
    note: '수동 배정으로 만든 대진도 재구성하면 무작위 배정으로 바뀝니다.',
  },
  {
    icon: CalendarDays,
    title: '경기 일정 입력',
  ...
  },
  {
    ...
    steps: [
      '홈 화면 상단 또는 각 대진 화면의 "게스트 URL" 버튼을 누르면 링크가 클립보드에 복사됩니다.',
...
const GUEST_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      '우상단 "관리자 로그인" 버튼은 관리자 본인용입니다 — 비밀번호를 모르면 관리 기능에 접근할 수 없습니다.',
    ],
    note: '게스트 화면은 로그인 여부와 무관하게 항상 열람 전용입니다. 관리자가 자기 게스트 링크를 열어도 열람 화면이 먼저 보이며, "관리자 화면" 버튼을 눌러야 관리 모드로 전환됩니다.',
  },
  {
    icon: Search,
    title: '학교별 경기 조회',
